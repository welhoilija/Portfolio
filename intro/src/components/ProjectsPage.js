      ...
      >
        ...
        >
          <Grid item xs={12} sm={12} md={6} lg={3} xl={3} align="center">
            <MyCard
              className={"dark-mode"}
              text="Advanced crypto portfolio with django + celery backend and JS/Bootstrap front."
              title="Crypto Portfolio Web-App (2021)"
          ...
          <Grid item xs={12} sm={12} md={6} lg={3} xl={3} align="center">
            <MyCard
              text="React/FastApi app for making reservations and sharing with friends. Go check it out!"
              title="Dinner Planner App (2023)"
              image="/static/images/dinnerbooking.png"
              link="https://github.com/welhoilija/DinnerPlanner"
            />
          </Grid>
        ...
        <Grid item xs={12} align="center">
          <Typography>I also have several private projects.</Typography>
        </Grid>
      </Grid>
    </Box>
  );
